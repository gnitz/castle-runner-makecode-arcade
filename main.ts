...
let sprTutorial : Sprite = null
let sprStart : Sprite = null
let tutFlag = false
...
storyboard.registerScene("gameStart", function () {
    ...
    `, SpriteKind.boat)
    sprShip.setPosition(100, 85)
    sprShip.setVelocity(-6, 0)
    sprShip.setFlag(SpriteFlag.BounceOnWall, true)
    ...
    scene.setBackgroundImage(img`
        ...
        f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f 3 f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f
   ...
   `, img`
    ...
    game.onUpdateInterval(Math.randomRange(2500, 4500), function () {
        ...
        castleBat.setFlag(SpriteFlag.RelativeToCamera, true)
   ...
   `, img`
    ...
    game.onUpdateInterval(Math.randomRange(12500, 18000), function () {
        ...
        clouds.setFlag(SpriteFlag.RelativeToCamera, true)
        clouds.x = 0
   ...
   `, img`
            ...
            enemyVehicle = sprites.createProjectileFromSide(img`
                ...
                . . . . . . . . . d d d d d . . . 4 . . . . . .
                . . . . . . . . . . d d d d . . . . . . . . . .
                . . . . . e b b b b d d d d b b b b b . . . . .
                . . . . . e e b b b b d d d b b b b b b . . . .
                . . . . . e e 1 1 e e e e e e e e e e 1 1 . . .
                . . . . . e e 1 e e e e e e e e e e e e 1 . . .
                . . . 1 . e e e e e e e e e e e e e e e e . . .
                . . 1 1 . e f e e e e e e e e e e e e e e . . .
            ...
            animation.runImageAnimation(
                ...
                [img`
                    ...
                    . . . . . e e b b b b d d d b b b b b b . . . .
                    . . . . . e e 1 1 e e e e e e e e e e 1 1 . . .
                    . . . 1 . e e 1 e e e e e e e e e e e e 1 . . .
                    . . 1 1 . e e e e e e e e e e e e e e e e . . .
                    . 1 . . . e f e e e e e e e e e e e e e e . . .
                    1 1 1 1 1 1 1 e e e e e e e e e e e e e e . . .
                    . . . . . e f e e e e e e e e e e e e e e . . .
                    . . . . . e e e e e e e e e e e e e e e e . . .
                    . . . . . e e e e e e e e e e e e e e e e . . .
   ...
   `, img`
    ...
    game.onUpdateInterval(Math.randomRange(40000, 45000), function () {
        sprShip.setPosition(100, 85)
        sprShip.setFlag(SpriteFlag.Invisible, false)
        sprShip.setVelocity(Math.randomRange(-3, -6), 0)
    })
    ...
    scene.onHitWall(SpriteKind.boat, function (sprite) {
        sprShip.setFlag(SpriteFlag.Invisible, true)
    })
    ...
    function lvlUp(level: number) {
        textSprite.say("Wave" + level, 2000)
        textSprite.y = (screen.height)/ 3;
        textSprite.x = (screen.width)/2;
...
storyboard.registerScene("titleScreen", function () {
    ...
    controller.B.onEvent(ControllerButtonEvent.Pressed, function () {
        ...
        game.showLongText("Press \"A\" or \"Up\" to jump, press down longer to jump higher", DialogLayout.Bottom)
